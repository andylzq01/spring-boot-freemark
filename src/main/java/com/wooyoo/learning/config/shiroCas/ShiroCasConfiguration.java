package com.wooyoo.learning.config.shiroCas;
...
//      <!-- 用户授权/认证信息Cache, 采用EhCache 缓存 -->
    ...
    public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultWebSecurityManager securityManager, CasFilter casFilter, TbUserMapper userDao) {
     ...
     * @create  2016年1月14日
     */
    private void loadShiroFilterChain(ShiroFilterFactoryBean shiroFilterFactoryBean, TbUserMapper userDao){
        /////////////////////// 下面这些规则配置最好配置到配置文件中 ///////////////////////
